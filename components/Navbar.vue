...
const menus: Menu[] = [
   { name: 'Your Profile', link: '/profile', icon: 'uil:user-square' },
   { name: 'Your Friend', link: '/friend', icon: 'uil:users-alt' },
   { name: 'Your plan', link: '/plan', icon: 'uil:clipboard-blank' },
   { name: 'Your wallet', link: '/wallet', icon: 'uil:wallet' },
   { name: 'Your health', link: '/health', icon: 'icon-park-outline:muscle' },
   { name: 'Setting', link: '/setting', icon: 'uil:setting' }
]
const is_open = ref(false);
const location = {
   province: provinces.get('นครปฐม'),
   country: 'Thailand'
}
